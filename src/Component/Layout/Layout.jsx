...
import AllFranchise from "../Pages/AllFranchise/AllFranchise";
import AllFranchiseDetails from "../Pages/AllFranchise/AllFranchiseDetails";
import AddPinCode from "../Pages/AllFranchise/AddPinCode";
import FranchiseDrivers from "../Pages/AllFranchise/FranchiseDrivers";
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 p-6 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <Routes>
            ...
            <Route path="/top-drivers" element={
              <ProtectedRoute>
                <TopDrivers />
              </ProtectedRoute>
            } />
            <Route path="/top-driver-details/:driverId" element={
              <ProtectedRoute>
                <TopDriverDetails />
              </ProtectedRoute>
            } />
            <Route path="/all-drivers" element={
              <ProtectedRoute>
                <AllDrivers />
              </ProtectedRoute>
            } />
            <Route path="/all-driver-details/:driverId" element={
              <ProtectedRoute>
                <AllDriverDetails />
              </ProtectedRoute>
            } />
            <Route path="/all-passengers" element={
              <ProtectedRoute>
                <AllPassengers />
              </ProtectedRoute>
            } />
            <Route path="/all-passenger-details/:passengerId" element={
              <ProtectedRoute>
            ...
            <Route path="/active-rides-details/:activeRideId" element={
              <ProtectedRoute>
                <ActiveRidesDetails />
              </ProtectedRoute>
            } />
            <Route path="/due-request" element={
              <ProtectedRoute>
                <DueRequest />
              </ProtectedRoute>
            } />
            <Route path="/due-request/:dueRequestId" element={
              <ProtectedRoute>
                <DueRequestDetails />
              </ProtectedRoute>
            } />
            ...
            <Route path="/ride-history/:rideHistoryId" element={
              <ProtectedRoute>
                <RideHistoryDetails />
              </ProtectedRoute>
            } />
            ...
            <Route path="/all-franchise" element={
              <ProtectedRoute>
                <AllFranchise />
              </ProtectedRoute>
            } />
            <Route path="/franchise-drivers/:franchiseId" element={
              <ProtectedRoute>
                <FranchiseDrivers />
              </ProtectedRoute>
            } />
            <Route path="/franchise-drivers-details/:driverId" element={
              <ProtectedRoute>
                <FranchiseDriverDetails />
              </ProtectedRoute>
            } />
            <Route path="/franchise-details/:franchiseId" element={
              <ProtectedRoute>
                <AllFranchiseDetails />
              </ProtectedRoute>
            } />
            <Route path="/add-pinCode/:pinCodeId" element={
              <ProtectedRoute>
                <AddPinCode />
              </ProtectedRoute>
            } />
